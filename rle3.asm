...
Interleaved              
               ...
               sta            Max_HIGHBYTE+1  ; exiting program at the end of screen
Operator Calc               
               lda            #<RLE_Char+1     ; Set up pointer to Label RLE_NUM
               sta            Get_Data+1      ; for use in Draw_Screen routine
               lda            #>RLE_Char+1     ; This will load # of bytes to repeat
               sta            Get_Data+2
Operator Hilo               
...
Operator Calc                              
               lda            #<RLE_Color+1    ; Set up pointer to Label RLE_CNUM
               sta            Get_Data+1      ; for use in Draw_Screen routine
               lda            #>RLE_Color+1    ; This will load # of bytes to repeat
               sta            Get_Data+2
